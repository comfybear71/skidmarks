...
Next trial if he wants it: **32 or 96** frames on the same graph, then IP-Adapter 0.5 on an **art** still (not a person plate).
...
- Do not run the 96-frame recipe onto Forgotten intermissions until he names that test.
