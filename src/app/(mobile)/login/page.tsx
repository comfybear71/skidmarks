  ...
  return (
    <main className="mobile-shell" style={{ minHeight: "100dvh", padding: "32px 16px" }}>
      ...
      <div style={{ color: "var(--chrome-dim)", fontSize: "13px", marginTop: "8px", maxWidth: "28rem" }}>
        Your packs stay yours. Mum (or anyone else in the env list) signs in with their
        email and gets their own Skidmarks and Sunny Banks.
      </div>
      <form onSubmit={(e) => void onSubmit(e)} style={{ marginTop: "24px", display: "grid", gap: "12px", maxWidth: "22rem" }}>
        <label style={{ display: "grid", gap: "4px" }}>
          <span style={{ fontSize: "11px", letterSpacing: "0.08em", textTransform: "uppercase", color: "var(--chrome-dim)" }}>
            Email
          </span>
          <input
            type="email"
