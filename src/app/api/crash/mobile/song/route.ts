 ...
 *   add-plate — put a plate on the list at 1 × 15s. Leftover rendered mp4 hangs after the last hung bar (file first, real file length). Does not mint WAITING. Already hung + extra mp4 → hang that file after the last bar. Do not stack a second take at the same clock. No cook.
