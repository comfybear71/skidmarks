/**
 * Two people can use the studio. Emails + passwords live in env.
 * Homepage stays public. /m, /scratch, Crash Lab, and APIs need a cookie.
 *
 * STUDIO_USERS=you@x.com:password,mum@x.com:otherpassword
 *
 * Dynamic env lookup — Next 16 inlines process.env.NAME at build time.
 * Leave STUDIO_USERS blank = no login (this PC / cloud VM).
 */
...
/** Anyone can see these without a cookie. Everything else is the studio. */
